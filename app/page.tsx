          ...
          <section className="bg-white px-6 md:px-8 py-16 md:py-24 lg:py-28">
            <div className="container mx-auto max-w-7xl">
              <div className="relative text-center mb-8 md:mb-12">
                ...
                <h3 className="text-gray-900 font-semibold tracking-tight text-2xl md:text-3xl lg:text-4xl mt-1">
                  Our solution
                </h3>
                <img
                  src="/svgs/curved-arrow-left.svg"
                  alt="arrow pointing to problem"
                  className="hidden md:block absolute left-8 top-12 w-16 md:w-20"
                />
                <img
                  src="/svgs/curved-arrow-right.svg"
                  alt="arrow pointing to solution"
                  className="hidden md:block absolute right-8 top-12 w-16 md:w-20"
                />
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-6 md:gap-8 items-stretch">
                ...
                <div className="space-y-4 md:space-y-6">
                  <div className="bg-white rounded-xl border border-[#E6EAF2] shadow-[0_1px_2px_rgba(16,24,40,0.06),_0_8px_24px_rgba(16,24,40,0.04)] p-5 md:p-6 text-left">
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                      Reps spend hours{" "}
                      <span className="font-semibold text-gray-900">copy‑pasting decks, PDFs and blog snippets</span>{" "}
                      for each prospect and still ship off‑brand pitches.
                    </p>
                  </div>
                  <div className="bg-white rounded-xl border border-[#E6EAF2] shadow-[0_1px_2px_rgba(16,24,40,0.06),_0_8px_24px_rgba(16,24,40,0.04)] p-5 md:p-6 text-left">
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                      Personalization stalls pipeline—
                      <span className="text-red-500 font-semibold">context lives across tools</span> (docs, case
                      studies, slides), so follow‑ups are slow and generic.
                    </p>
                  </div>
                  <div className="bg-white rounded-xl border border-[#E6EAF2] shadow-[0_1px_2px_rgba(16,24,40,0.06),_0_8px_24px_rgba(16,24,40,0.04)] p-5 md:p-6 text-left">
                    <p className="text-gray-700 text-base md:text-lg leading-relaxed">
                      Marketing’s best proof points{" "}
                      <span className="font-semibold text-gray-900">don’t make it into outreach</span>—so buyers don’t
                      see the story that actually converts.
                    </p>
                  </div>
                </div>
                ...
                <div>
                  <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-2xl border border-[#E6EAF2] shadow-[0_1px_2px_rgba(16,24,40,0.06),_0_8px_24px_rgba(16,24,40,0.04)] p-5 md:p-6">
                    <div className="flex items-center space-x-3 mb-3 md:mb-4">
                      <img src="/logo.svg" alt="PitchFabric logo" className="w-9 h-9 md:w-10 md:h-10 rounded-lg" />
                    ...
                    <h4 className="text-gray-900 font-semibold text-xl md:text-2xl mb-3 md:mb-4">
                      Ship on-brand, personalized microsites in seconds
                    </h4>
                    <div className="space-y-3">
                      {[
                        "Auto‑ingest decks, PDFs, and blog posts",
                        "AI builds a brand‑perfect narrative for each lead",
                        "One smart link—interactive, trackable, always on‑brand",
                        "Engagement analytics + intent scoring in your CRM",
                        "HubSpot & Salesforce integrations (coming soon)",
                      ].map((item, i) => (
